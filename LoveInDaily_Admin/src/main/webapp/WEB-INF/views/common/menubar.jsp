      ...
      <div class="navbar-header" data-logobg="skin5">
         ...
         <a class="navbar-brand"
            ...
            <b class="logo-icon p-l-10"> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
               ...
               <!-- dark Logo text --> <img
               src="${pageContext.request.contextPath }/resources/assets/images/logoText.png"
               alt="homepage" class="light-logo" />

         </span> <!-- Logo icon --> <!-- <b class="logo-icon"> --> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
            <!-- Dark Logo icon --> <!-- <img src="${pageContext.request.contextPath }/resources/assets/images/logo-text.png" alt="homepage" class="light-logo" /> -->
